...
// bn.guiSetupEvents = function () {
//     document.querySelector(".bnView").addEventListener("click", async (event) => {
//         const targetNode = event.target.closest(".node h3");
//         if (targetNode) {
//             const nodeName = targetNode.closest(".node").dataset.name;
//             const detailContent = bn.influences[nodeName]?.detail || "No detailed information available.";

//             // Display the detail under Influence Descriptions
//             const influenceDescriptions = document.querySelector(".influenceDescriptions");
//             const detailHtml = `
//                 <div class="detail-section">
//                     <h3>Detail: How finding out ${nodeName} contributes:</h3>
//                     ${detailContent}
//                 </div>
//             `;
//             influenceDescriptions.innerHTML = detailHtml;
//         }
//     });
// };
