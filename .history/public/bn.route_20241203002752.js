					...
					if (req.query.evidence) {
						...
						for (let nonActiveNodeName of Object.keys(evidence)) {
							...
							Object.keys(evidence).forEach(nonActiveNodeName => {
								...
								// Combine sentences into explanation
								influenceData.explanation = influenceData.sentences.join('\n');

								// Store influence data for the current nonActiveNodeName
								bn.influences[nonActiveNodeName] = influenceData;
							});
						}
